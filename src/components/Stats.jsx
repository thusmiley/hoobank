...
const Stats = () => (
  <section className={`flex flex-wrap sm:mb-8 mb-6 lg:justify-around`}>
    {stats.map((stat) => (
      <div key={stat.id} className={`flex justify-start items-center flex-row my-3 ss:my-6 ss:mr-6 md:mr-10 text-left`}>

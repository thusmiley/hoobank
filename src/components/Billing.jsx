  ...
  <section id="product" className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        ...
        alias modi quos nesciunt praesentium sed quae laborum aliquam voluptates
        magni voluptatibus perspiciatis eaque totam consequatur iure incidunt
        necessitatibus ratione eos sequi officia.
      </p>
